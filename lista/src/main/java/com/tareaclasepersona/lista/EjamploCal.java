 ...
 * @author USUARIO
 */
public class EjamploCal extends javax.swing.JFrame {

    /**
     * Creates new form EjamploCal
     */
    public EjamploCal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjamploCal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjamploCal().setVisible(true);
            }
        });
    }
